...
╭─ Options ────────────────────────────────────────────────────────────────────────────────────────────────────────────────────╮
│ *  --mode                   [dereplication|votu-clustering|spp-clustering]  dereplication | votu-clustering | spp-clustering │
│                                                                             [required]                                       │
│ *  --input-contigs          PATH                                            Input FASTA [required]                           │
│    --output-folder          PATH                                            Output directory [default: clustered-contigs]    │
│    --threads                INTEGER RANGE [x>=0]                            0=all cores; otherwise N threads [default: 0]    │
│    --vclust-params          TEXT                                            Custom vclust parameters like: "--min-kmers 20   │
